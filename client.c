...
void searchAccount(int sd)
{
    ...
    if (type == 1)
    {
        ...
        if (len == 0)
        {
            write(1, "Re-check User ID!\n\n", sizeof("Re-check User ID!\n\n"));
        }
